...
export function TheGraphComponent({ chart }) {
  ...
  // 1. call useState - store windowResize, setwindowResize
  // 2. build function that checks what the windowResize is
  //  a. call setWindowResize to update the size of chart, and rerender
  //3. return if .. else if... else value : breakpoints
